...
const CandidatesTable = ({setSelectedUserID}: {setSelectedUserID:Dispatch<SetStateAction<number>>}) => {
  return (
    <div>
    {users.map((user) => {
      ...
      return (
        <div key={user.id} className="flex justify-between items-center px-4 hover:bg-primary hover:cursor-pointer" onClick={()=>setSelectedUserID(user.id)}>
